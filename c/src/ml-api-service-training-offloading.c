 ...
 */
static int
_ml_service_training_offloadin_conf_parse_json (_ml_offloading_service_s *
 ...
 */
static int
_ml_service_create_training_offloading (_ml_offloading_service_s * offloading_s)
{
  ml_training_services_s *training_s = NULL;
 ...
 */
int
ml_service_training_offloading_create (_ml_offloading_service_s * offloading_s,
    JsonObject * object)
{
  int status;
 ...
 */
int
ml_service_training_offloading_set_path (_ml_offloading_service_s *
    offloading_s, const gchar * name, const gchar * path)
{
  ...
  if (!offloading_s) {
    _ml_error_report_return (ML_ERROR_INVALID_PARAMETER,
        "The parameter, 'remote_s' (_ml_offloading_service_s), is NULL.");
  }
