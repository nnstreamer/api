 ...
 */
int
_ml_information_iterate (ml_information_h ml_info,
    ml_information_iterate_cb iterate, void *user_data)
{
  ml_info_s *_info;
  ...
  if (!iterate) {
    _ml_error_report_return (ML_ERROR_INVALID_PARAMETER,
        "The parameter, 'iterate' is NULL. It should be a valid function.");
  }
