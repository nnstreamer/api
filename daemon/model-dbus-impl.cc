    ...
    const gchar *description)
{
  ...
  try {
    /**
     * @todo update the description of the given model to the DB.
    */
    db.connectDB ();
    ...
    const guint version)
{
  ...
  try {
    /**
     * @todo activate the given model to the DB.
    */
    db.connectDB ();
    ...
    const gchar *name)
{
  ...
  try {
    /**
     * @todo get the active status of the given model from the DB.
    */
    db.connectDB ();
    ...
    )
{
  ...
  try {
    /**
     * @todo get all the models from the DB.
    */
    db.connectDB ();
    ...
    const guint version)
{
  ...
  try {
    /**
     * @todo delete the given model from the DB.
    */
    db.connectDB ();
