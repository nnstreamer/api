...
#------------------------------------------------------
# nnstreamer for android
#------------------------------------------------------
include $(CLEAR_VARS)

LOCAL_MODULE := nnstreamer_android

LOCAL_SRC_FILES := nnstreamer-native-init.c
...
LOCAL_EXPORT_LDLIBS := $(NNS_API_FLAGS)
LOCAL_EXPORT_C_INCLUDES := $(NNSTREAMER_INCLUDES) $(NNSTREAMER_CAPI_INCLUDES) $(GST_HEADERS_COMMON)
...
LOCAL_CFLAGS := -O3 -fPIC $(NNS_API_FLAGS)
LOCAL_STATIC_LIBRARIES := nnstreamer_android
