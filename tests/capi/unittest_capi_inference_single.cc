...
TEST (nnstreamer_capi_ml_information, iterate)
{
  ...
  status = _ml_information_iterate (info, _test_ml_information_iter, count);
  EXPECT_EQ (status, ML_ERROR_NONE);
...
TEST (nnstreamer_capi_ml_information, iterateInvalidParam01_n)
{
  ...
  status = _ml_information_iterate (NULL, _test_ml_information_iter, NULL);
  EXPECT_EQ (status, ML_ERROR_INVALID_PARAMETER);
}
...
TEST (nnstreamer_capi_ml_information, iterateInvalidParam02_n)
{
  ...
  status = _ml_information_iterate (info, NULL, NULL);
  EXPECT_EQ (status, ML_ERROR_INVALID_PARAMETER);
