 ...
 */
static void
_extension_test_add_cb_new_data (ml_service_h handle, const char *name,
    const ml_tensors_data_h data, void *user_data)
{
 ...
 */
static inline void
_extension_test_add (ml_service_h handle)
{
  extension_test_data_s *tdata;
  ...
  tdata = _create_test_data ();
  ASSERT_TRUE (tdata != NULL);

  cb.new_data = _extension_test_add_cb_new_data;

  status = ml_service_set_event_cb (handle, &cb, tdata);
  EXPECT_EQ (status, ML_ERROR_NONE);
 ...
 */
static void
_extension_test_imgclf_cb_new_data (ml_service_h handle, const char *name,
    const ml_tensors_data_h data, void *user_data)
{
  extension_test_data_s *tdata = (extension_test_data_s *) user_data;
  void *_raw = NULL;
 ...
 */
static inline void
_extension_test_imgclf (ml_service_h handle)
{
  extension_test_data_s *tdata;
  ...
  cb.new_data = _extension_test_imgclf_cb_new_data;
